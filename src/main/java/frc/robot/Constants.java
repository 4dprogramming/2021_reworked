...
public class Constants {
    ...
    public static final double kAccP = 0.01;
    public static final double kAccI = 0.0135;
    public static final double kAccD = 0.0135;
    ...
    public static double kShootingAngle = 0;
